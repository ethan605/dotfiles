...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap("<space>ca", ":FzfLua lsp_code_actions formatter=path.filename_first<CR>")
  buf_set_keymap("<space>s", ":FzfLua lsp_document_symbols formatter=path.filename_first<CR>")
