...
-- Invalid settings
-- vim.opt.nobackup = true             -- Some LSP servers have issues with backup files
-- vim.opt.noerrorbells = true         -- No beeps.
-- vim.opt.nofoldenable = true			    -- Not folding by default
-- vim.opt.nojoinspaces = true         -- Prevents inserting two spaces after punctuation on a join (J)
-- vim.opt.nostartofline = true        -- Do not jump to first character with page commands.
-- vim.opt.noswapfile = true           -- Disable swap files
-- vim.opt.nowritebackup = true        -- Some LSP servers have issues with backup files
-- }}}
